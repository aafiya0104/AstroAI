...
const footerLinks = [
  ...
  },
  {
    title: "Project",
    links: [
      { label: "Source Code", href: "https://github.com/aafiya0104/AstroAI" },
      { label: "Report an Issue", href: "https://github.com/aafiya0104/AstroAI/issues" },
    ],
  },
];
                ...
                {section.links.map((link) => (
                  <li key={link.label}>
                    <a
                      ...
                      className="text-white hover:text-[#905BF4] transition-colors"
                    >
                      {link.label}
                    </a>
                  </li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm space-y-4 md:space-y-0">
          <div className="flex space-x-6 text-white">
            <a
              ...
              rel="noreferrer"
              aria-label="GitHub"
              className="hover:text-[#905BF4] transition-colors"
            >
